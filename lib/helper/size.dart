// ignore_for_file: no_leading_underscores_for_local_identifiers, constant_identifier_names, depend_on_referenced_packages
...
class MySize {
  ...
  * */
  static double getFontSize(
      {double? width, double? height, double size = 1000}) {
    double _width = width ?? _size.width;
    double _height = height ?? _size.height;
    // Default screen portrait
    if (_width > _height) {
